...
<body background="<%= request.getContextPath() %>/StudentSearch.jpg" style="background-repeat: no-repeat; background-size: cover;">
    ...
    <c:choose>
        <c:when test="${student ne null || !empty student}">
           <center><table border="1px" text-align="center">
   <th>Student ID</th>
            <th>Student Name</th>
    ...
    <tr>
        ...
        <td style="text-align: center;">${student.studentDepartment}</td>
        <td style="text-align: center;">${student.studentYear }</td>
        <td style="text-align: center;">${student.studentCourse }</td>
        <td style="text-align: center;">${student.studentPhoneno }</td>
        <td style="text-align: center;">${student.studentEmail }</td>
    </tr>
</table></center>
        </c:when>
        <c:otherwise>
